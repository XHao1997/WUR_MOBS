...
plt.plot(tsim, y_hat,label = 'estimated parameters')
plt.plot(tsim, y0, label = 'starting parameters')
plt.plot(t_data, y_data[:,0],  label='measured data pred', marker='x', linestyle = '')
plt.plot(t_data, y_data[:,1], label='measured data pred', marker='x', linestyle = '')
plt.show()
